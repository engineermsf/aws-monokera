...
# Límite opcional para pruebas (ej. EXTRACCION_MAX_ITEMS=1 en Lambda). None = sin límite.
_max = os.environ.get("EXTRACCION_MAX_ITEMS")
MAX_ITEMS_TOTAL = int(_max) if (_max is not None and str(_max).strip().isdigit()) else None
